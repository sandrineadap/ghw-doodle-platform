...
const CanvasComponent = forwardRef<CanvasRef, CanvasProps>(
  ({ selectedColour, brushSize, isErasing }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      clearCanvas: () => {
        if(canvasContext && canvasRef.current) {
          canvasContext.clearRect(0, 0, canvasRef.current.width, canvasRef.current.height); // clears that part of the canvas
        }
      }
    }), [canvasContext])
